...
export default function Dashboard() {
  ...
  return (
    <div className={cn("min-h-screen bg-[#050505] text-zinc-100 max-w-[1600px] mx-auto relative overflow-hidden")}>
      ...
      <div className={cn("space-y-12 pt-10 pb-20 px-6 transition-all duration-1000", isLoading ? "opacity-0 scale-95 blur-xl pointer-events-none" : "opacity-100 scale-100 blur-0")}>
