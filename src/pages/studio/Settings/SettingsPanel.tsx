  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        exit={{ opacity: 0, y: -10 }}
        className="bg-zinc-950 border border-white/5 rounded-[3rem] p-10 min-h-[400px]"
      >
        {activeTab === 'general' && (
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                ...
                { label: "Auto-Sync Archives", desc: "Automatically backup projects to the neural cloud.", default: false },
              ].map(item => (
                <div key={item.label} className="flex items-center justify-between p-6 bg-zinc-900/50 rounded-[2rem] border border-white/5">
