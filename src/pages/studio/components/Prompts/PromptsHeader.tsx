...
import { ChevronLeft, ChevronRight, Cpu, ImageIcon, RefreshCw, Terminal } from 'lucide-react';
  ...
  return (
    <TooltipProvider>
      <div className="relative group">
        ...
        <div className="absolute -inset-1 bg-gradient-to-r from-studio/20 via-blue-500/10 to-studio/20 rounded-[2rem] blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-1000" />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 z-10 w-full lg:w-auto">
            <div className="relative shrink-0">
              <div className="w-14 h-14 rounded-2xl bg-studio/10 border border-studio/30 flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.2)] group/icon overflow-hidden">
                ...
                <ImageIcon className="w-7 h-7 text-studio relative z-10 animate-pulse-slow" />
            ...
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-[8px] md:text-[9px] font-black text-studio/40 uppercase tracking-[0.2em] md:tracking-[0.4em]">S{session} // EP{episode} // Neural Prompt Synthesis Engine V5.1</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full lg:w-auto">
            {onPrev && (
              <Tooltip>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Return to SEO Optimization</p>
                </TooltipContent>
              </Tooltip>
            )}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                ...
                <TooltipTrigger>
                  ...
                  >
                    ...
                    {isGenerating ? (
                      ...
                      <Terminal className="w-4 h-4 mr-3 text-studio group-hover/btn:scale-110 transition-transform duration-500" />
                    )}
                    <span className="relative z-10">GENERATE PROMPTS</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Synthesize Neural Image Generation Prompts</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger>
                  ...
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      NEXT: SCREENING <ChevronRight className="w-4 h-4 group-hover/next:translate-x-1 transition-transform" />
                    </span>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Proceed to Screening Room</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
