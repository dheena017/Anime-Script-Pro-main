...
import { Users, RefreshCw, ChevronRight, ChevronLeft, Fingerprint, Cpu } from 'lucide-react';
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-between p-5 md:p-6 bg-[#050505]/80 backdrop-blur-3xl border border-studio/20 rounded-[2rem] shadow-2xl overflow-hidden gap-6 lg:gap-0">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full lg:w-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            ...
            <Button 
              className="relative w-full sm:w-auto h-11 px-8 bg-black/60 border-zinc-800 text-zinc-400 hover:text-studio hover:border-studio/30 font-black uppercase tracking-widest text-[10px] rounded-2xl transition-all duration-300 backdrop-blur-md overflow-hidden group/next"
              onClick={onNext}
            >
