...
export const CastView: React.FC<CastViewProps> = ({
  ...
  const { castData, castList } = useGenerator();
            ...
            >
              ...
              <div className="p-8 border-b border-zinc-900 bg-studio/5">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 group-hover:text-studio group-hover:border-studio/30 transition-colors">
              ...
              <div className="p-8 grid grid-cols-2 gap-8 relative">
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-orange-500/5 border border-orange-500/10 p-3 rounded-2xl blur-[2px] hover:blur-none transition-all duration-700 cursor-help">
