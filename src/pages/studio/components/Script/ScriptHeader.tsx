...
import { ChevronLeft, ChevronRight, Cpu, RefreshCw, Terminal } from 'lucide-react';
  ...
  return (
    <TooltipProvider>
      <div className="relative group">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between p-4 md:p-5 bg-[#050505]/95 backdrop-blur-3xl border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              {onPrev && (
                <Tooltip>
                  ...
                  <TooltipContent side="top">
                    <p className="font-black uppercase tracking-widest text-[9px]">Return to Series Architect</p>
                  </TooltipContent>
                </Tooltip>
              )}
              ...
              <Tooltip>
                <TooltipTrigger >
                  <Button
                    variant="outline"
                    className="relative h-12 px-8 bg-[#050505] border-white/10 text-zinc-100 hover:text-studio hover:border-studio/50 font-black uppercase tracking-widest text-[11px] rounded-full transition-all duration-500 backdrop-blur-xl group/btn shadow-2xl"
                  ...
                  >
                    ...
                    {isGenerating ? (
                      ...
                      <RefreshCw className="w-4 h-4 mr-3 text-studio group-hover/btn:rotate-180 transition-transform duration-500" />
                    )}
                    <span className="relative z-10">GENERATE SCRIPT</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Manifest New Script Manifest</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger >
                  <Button
                    className="relative h-12 px-10 rounded-full bg-[#050505] border border-white/10 text-zinc-400 hover:text-studio hover:border-studio/50 font-black uppercase tracking-widest text-[10px] transition-all duration-500 backdrop-blur-xl group/next shadow-2xl"
                    onClick={onNext}
                    disabled={isGenerating}
                  >
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Proceed to Visual Storyboard</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
