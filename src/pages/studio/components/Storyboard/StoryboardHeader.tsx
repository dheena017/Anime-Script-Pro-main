          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full lg:w-auto">
            {onPrev && (
              <Tooltip>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Return to Script Nexus</p>
                </TooltipContent>
              </Tooltip>
            )}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Tooltip>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Synthesize Visual Production Blueprint</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Proceed to SEO Optimization</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
