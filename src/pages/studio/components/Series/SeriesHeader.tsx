...
import { ChevronLeft, ChevronRight, Cpu, Layers, LayoutGrid, RefreshCw } from 'lucide-react';
  ...
  return (
    <TooltipProvider>
      <div className="relative group">
        ...
        <div className="absolute -inset-1 bg-gradient-to-r from-studio/20 via-indigo-500/10 to-studio/20 rounded-[2rem] blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-1000" />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 z-10 w-full lg:w-auto">
            ...
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-[8px] md:text-[9px] font-black text-studio/40 uppercase tracking-[0.2em] md:tracking-[0.4em]">S{session} // EP{episode} // Neural Series Synthesis Engine V4.2</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full lg:w-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                ...
                <TooltipTrigger >
                  ...
                  >
                    ...
                    {isGenerating ? (
                      ...
                      <LayoutGrid className="w-4 h-4 mr-3 text-studio group-hover/btn:rotate-90 transition-transform duration-500" />
                    )}
                    <span className="relative z-10">GENERATE SERIES</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Map Neural Series Trajectory</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent side="top">
                  <p className="font-black uppercase tracking-widest text-[9px]">Proceed to Script Nexus</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
