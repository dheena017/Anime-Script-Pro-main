...
const PROTOCOL_TABS = [
  { id: 'script', label: 'Script', path: 'architect', icon: ScrollText },
  { id: 'world', label: 'World', path: 'oracle', icon: Globe },
  { id: 'cast', label: 'Cast', path: 'forge', icon: UserPlus },
  { id: 'visual', label: 'Visual', path: 'visual', icon: ImageIcon },
  { id: 'motion', label: 'Motion', path: 'motion', icon: Zap },
  { id: 'series', label: 'Series', path: 'showrunner', icon: Layers },
  { id: 'seo', label: 'SEO', path: 'seo', icon: Search },
  { id: 'utils', label: 'Utils', path: 'aide', icon: SlidersHorizontal },
];
