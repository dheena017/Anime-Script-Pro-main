          ...
          >
            ...
            <div className="p-4 sm:p-8 border-b border-cyan-500/20 flex items-center justify-between bg-gradient-to-br from-cyan-500/10 via-transparent to-transparent shrink-0 relative overflow-hidden">
              ...
              <div className="space-y-1 relative z-10">
                ...
                <p className="text-[10px] font-bold text-cyan-500/60 uppercase tracking-widest flex items-center gap-2">
                  <span className="w-4 h-[1px] bg-cyan-900" /> System Configuration
                </p>
              </div>
              <button
                onClick={onToggle}
              ...
              <div className="pt-8 space-y-4">
                {generatedScript && (
                  <Button
                    ...
                    className="w-full h-12 bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 text-[10px] font-black uppercase tracking-[0.2em] border border-cyan-500/30 rounded-xl transition-all flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(6,182,212,0.1)] group"
                  >
