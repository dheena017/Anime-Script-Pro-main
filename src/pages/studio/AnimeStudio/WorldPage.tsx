...
import { Globe, Sparkles, Heart, Zap } from 'lucide-react';
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                       ...
                       <div className="lg:col-span-3">
                          {isEditing ? (
                            <textarea
                              className="w-full h-[800px] bg-black/40 border border-studio/20 rounded-[2.5rem] p-10 text-zinc-300 font-mono text-sm leading-loose focus:outline-none focus:ring-2 focus:ring-studio/30 transition-all resize-none shadow-inner"
                              value={generatedWorld || ''}
                              onChange={(e) => setGeneratedWorld(e.target.value)}
                              placeholder="Manually architect your world lore here..."
                            />
                          ) : (
                            <div className="prose prose-invert prose-cyan max-w-none 
                              prose-h1:text-studio prose-h1:font-black prose-h1:uppercase prose-h1:tracking-[0.3em] prose-h1:text-2xl prose-h1:mb-10
                              prose-h2:text-white prose-h2:font-black prose-h2:uppercase prose-h2:tracking-[0.2em] prose-h2:text-sm prose-h2:bg-white/5 prose-h2:p-6 prose-h2:rounded-2xl prose-h2:border prose-h2:border-white/5
                              prose-p:text-zinc-400 prose-p:leading-loose prose-p:text-[14px] prose-p:mb-10
                              prose-strong:text-studio prose-strong:font-black
                              prose-ul:border-l prose-ul:border-white/5 prose-ul:pl-8 prose-li:mb-4
                            ">
