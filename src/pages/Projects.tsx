    ...
    <div className="min-h-screen pt-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-zinc-500 mt-1 uppercase text-[10px] tracking-widest">MANAGE AND SWITCH BETWEEN YOUR ACTIVE STUDIO BLUEPRINTS.</p>
        </div>
        
        <button 
          onClick={() => navigate('/create/new')}
          className="flex items-center gap-2 px-6 py-3 bg-[#bd4a4a] text-white rounded-xl font-bold text-sm hover:bg-[#a33f3f] transition-all shadow-[0_4px_15px_rgba(189,74,74,0.3)]"
        >
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-[9px] font-black uppercase px-2 py-1 rounded bg-zinc-800 text-zinc-400`}>
                    {project.status}
                  </span>
                  <button 
